...
class Fusion:
    ...
    def fusion(self, AIS_vis, AIS_cur, Vis_tra, Vis_cur, timestamp):
        """
        Main fusion method - original FUSPRO interface
        
        Args:
            AIS_vis: AIS trajectory DataFrame  
            AIS_cur: Current AIS data DataFrame
            Vis_tra: VIS trajectory DataFrame
            Vis_cur: Current VIS data DataFrame  
            timestamp: Current timestamp (ms)
            
        Returns:
            mat_list: Matched vessel data
            bin_cur: Active bindings
        """
